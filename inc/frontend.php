...
class CommentAvatarsFrontend extends CommentAvatars {
	 ...
	 */
	function styles() {
		wp_register_style( 'comment_avatars_style', WP_PLUGIN_URL . '/custom-avatars-for-comments/css/comment_avatars.css' );
	 ...
	 */
	function scripts() {
		wp_register_script( 'comment_avatars_js', WP_PLUGIN_URL . '/custom-avatars-for-comments/js/comment_avatars.js' );
